"""Functions to carry out different feature generation/selection/elimination techniques in spark framework."""
        ...
        rules: dict(col_name: rule_dict)
            ...
            example rule_dicts
                ...
                {'median_house_value':{
                    ...
                    - 'value': array of numbers(int/float); Buckets produced based on values provided
